    ...
    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 text-white p-4">
            <div class="flex items-center gap-2">
                ...
                <span class="font-semibold text-lg">Información de Ventas</span>
            </div>
        </div>
                ...
                >
                    ...
                    <div class="p-4">
                        <div class="overflow-x-auto">
                            <DataTable 
                                :value="formatVentaData(ventaData)" 
...
// Methods
const formatVentaData = (ventaData: any[]) => {
    if (!Array.isArray(ventaData)) return []

    const row = {}
    ventaData.forEach((item, index) => {
...
const formatVentaTitle = (key: string) => {
    const titleMap = {
        'VentasAnterior': 'Ventas Ejercicio Anterior',
        'VentasActual': 'Ventas Ejercicio Actual',
        'Ventas2023': 'Ventas 2023',
        'Ventas2024': 'Ventas 2024',
